...
def parse_args():
    ...
    # JSON and RSS options (now opt-in)
    parser.add_argument("-j", "--json", dest="json", action="store_true",
                      help="Output to JSON (default: disabled)")
    
    parser.add_argument("-rs", "--rss", dest="rss", action="store_true",
                      help="Output to RSS (default: disabled)")
